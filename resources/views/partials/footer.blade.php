    ...
    <div class="footer-container">
        <div class="footer-row">
            ...
            <div class="footer-links">
                <a href="tel:{!! App\create_link_phone(A::redclick("phone_number")) !!}" class="footer-link footer-link_phone">{!! A::redclick("phone_number") !!}</a>
                <a href="mailto:{!! A::redclick("email_address") !!}" class="footer-link footer-link_mail">{!! A::redclick("email_address") !!}</a>
                <a target="_blank" rel="nofollow" href="{!! A::redclick("fb_url") !!}" class="footer-link footer-link_fb"></a>
            </div>
        </div>
    </div>
</footer>
