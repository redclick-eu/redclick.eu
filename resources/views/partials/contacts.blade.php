...
<div class="bcontacts wow fadeIn">
    <div class="bcontacts-row">
        ...
        <div class="bcontacts-social bcontacts-social_tg">
            <a class="bcontacts-socialBg" href="{{A::get_field('tg_url')}}" target="_blank"><span>{!! wpcl_t('Write to Telegram') !!}</span></a>
        </div>
        <div class="bcontacts-social bcontacts-social_ms">
            <a class="bcontacts-socialBg" href="{{A::get_field('ms_url')}}" target="_blank"><span>{!! wpcl_t('Chat in Messenger') !!}</span></a>
        </div>
        <div class="bcontacts-social bcontacts-social_sk">
            <a class="bcontacts-socialBg" href="{{A::get_field('sk_url')}}" target="_blank"><span>{!! wpcl_t('Connect by Skype') !!}</span></a>
        </div>
