...
class Breadcrumbs {
    ...
    static $args = array(
        ...
        'title_patt'      => '<span class="breadcrumbs-title">%s<meta itemprop="position" content="$$pos$$" /></span>', // шаблон для последнего заголовка. Если включено: show_post_title или show_term_title
    ...
    function get_crumbs( $sep, $l10n, $args ){
        ...
        $arg->sep = '<span class="breadcrumbs-sep">'. $arg->sep .'</span>'; // дополним
